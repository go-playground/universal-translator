...
func (t *en_DE) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_DE'
func (t *en_DE) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_DE'
func (t *en_DE) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
