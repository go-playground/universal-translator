...
func (t *saq_KE) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'saq_KE'
func (t *saq_KE) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'saq_KE'
func (t *saq_KE) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
