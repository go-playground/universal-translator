...
func (t *en_VU) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_VU'
func (t *en_VU) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_VU'
func (t *en_VU) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
