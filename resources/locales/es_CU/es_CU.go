...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'es_CU'
func (t *es_CU) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
