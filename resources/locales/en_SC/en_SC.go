...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_SC'
func (t *en_SC) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
