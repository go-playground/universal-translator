...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_ER'
func (t *en_ER) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
