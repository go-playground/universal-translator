...
func (t *en_MG) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_MG'
func (t *en_MG) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_MG'
func (t *en_MG) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
