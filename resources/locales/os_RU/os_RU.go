...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'os_RU'
func (t *os_RU) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
