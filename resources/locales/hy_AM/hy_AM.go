...
func (t *hy_AM) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'hy_AM'
func (t *hy_AM) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'hy_AM'
func (t *hy_AM) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
