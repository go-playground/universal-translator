...
func (t *es_US) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'es_US'
func (t *es_US) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'es_US'
func (t *es_US) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
