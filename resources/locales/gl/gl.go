...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'gl'
func (t *gl) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
