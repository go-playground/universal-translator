...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'uk_UA'
func (t *uk_UA) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
