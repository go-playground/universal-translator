...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_GU'
func (t *en_GU) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
