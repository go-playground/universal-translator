...
func (t *en_GD) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_GD'
func (t *en_GD) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_GD'
func (t *en_GD) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
