...
func (t *shi_Latn_MA) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'shi_Latn_MA'
func (t *shi_Latn_MA) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'shi_Latn_MA'
func (t *shi_Latn_MA) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
