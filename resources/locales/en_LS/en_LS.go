...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_LS'
func (t *en_LS) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
