...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'so_ET'
func (t *so_ET) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
