...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'it'
func (t *it) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
