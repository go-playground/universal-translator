...
func (t *en_VC) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_VC'
func (t *en_VC) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_VC'
func (t *en_VC) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
