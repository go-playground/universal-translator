...
func (t *en_BS) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_BS'
func (t *en_BS) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_BS'
func (t *en_BS) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
