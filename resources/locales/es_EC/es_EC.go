...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'es_EC'
func (t *es_EC) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
