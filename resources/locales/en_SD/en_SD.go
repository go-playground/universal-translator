...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_SD'
func (t *en_SD) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
