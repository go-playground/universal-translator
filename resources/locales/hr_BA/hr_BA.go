...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'hr_BA'
func (t *hr_BA) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
