...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'es'
func (t *es) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
