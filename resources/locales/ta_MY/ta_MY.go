...
func (t *ta_MY) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'ta_MY'
func (t *ta_MY) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'ta_MY'
func (t *ta_MY) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
