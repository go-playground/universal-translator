...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'es_NI'
func (t *es_NI) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
