...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'sw_TZ'
func (t *sw_TZ) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
