...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_TK'
func (t *en_TK) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
