...
func (t *en_AS) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_AS'
func (t *en_AS) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_AS'
func (t *en_AS) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
