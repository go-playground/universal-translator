...
func (t *en_TO) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_TO'
func (t *en_TO) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_TO'
func (t *en_TO) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
