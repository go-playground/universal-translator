...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'sr_Latn_XK'
func (t *sr_Latn_XK) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
