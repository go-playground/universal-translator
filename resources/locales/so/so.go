...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'so'
func (t *so) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
