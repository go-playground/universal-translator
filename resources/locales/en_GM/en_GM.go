...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_GM'
func (t *en_GM) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
