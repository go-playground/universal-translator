...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_PG'
func (t *en_PG) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
