...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'ru'
func (t *ru) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
