...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'fr_SC'
func (t *fr_SC) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
