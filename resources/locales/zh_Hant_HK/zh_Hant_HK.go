...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'zh_Hant_HK'
func (t *zh_Hant_HK) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
