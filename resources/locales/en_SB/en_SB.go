...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_SB'
func (t *en_SB) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
