...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'fr_MG'
func (t *fr_MG) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
