...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'om_ET'
func (t *om_ET) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
