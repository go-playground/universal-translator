...
func (t *en_RW) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_RW'
func (t *en_RW) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_RW'
func (t *en_RW) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
