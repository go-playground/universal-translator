...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_CH'
func (t *en_CH) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
