...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'ru_KZ'
func (t *ru_KZ) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
