...
func (t *sr_Latn_BA) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'sr_Latn_BA'
func (t *sr_Latn_BA) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'sr_Latn_BA'
func (t *sr_Latn_BA) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
