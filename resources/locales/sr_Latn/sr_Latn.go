...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'sr_Latn'
func (t *sr_Latn) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
