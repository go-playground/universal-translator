...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'ro_RO'
func (t *ro_RO) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
