...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_MU'
func (t *en_MU) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
