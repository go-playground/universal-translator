...
func (t *en_FM) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_FM'
func (t *en_FM) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_FM'
func (t *en_FM) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
