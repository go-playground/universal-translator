...
// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_IE'
func (t *en_IE) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
