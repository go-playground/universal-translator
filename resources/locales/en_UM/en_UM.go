...
func (t *en_UM) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'en_UM'
func (t *en_UM) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'en_UM'
func (t *en_UM) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
