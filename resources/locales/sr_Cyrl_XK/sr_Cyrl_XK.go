...
func (t *sr_Cyrl_XK) Locale() string {
	return t.locale
}

// Plurals returns the list of plurals associated with 'sr_Cyrl_XK'
func (t *sr_Cyrl_XK) Plurals() []locales.PluralRule {
	return t.plurals
}

// cardinalPluralRule returns the PluralRule given 'num' and digits/precision of 'v' for 'sr_Cyrl_XK'
func (t *sr_Cyrl_XK) cardinalPluralRule(num float64, v uint64) locales.PluralRule {
