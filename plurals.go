...
// PluralRuler allows the plural rule to be found
...
// PluralRulerFunc for a given locale used to find the PluralRule for the given
// NumberValue
type PluralRulerFunc func(n NumberValue) PluralRule

// FindRule finds the actual PluralRules
