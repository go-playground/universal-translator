...
func TestDateTimeTh(t *testing.T) {
	...
	Equal(t, err, nil)
	Equal(t, dt, "วันจันทร์ที่ 2 มกราคม  2006")
	...
	Equal(t, err, nil)
	Equal(t, dt, "วันจันทร์ที่ 2 มกราคม  2006 15 นาฬิกา 04 นาที 05 วินาที")
	...
	Equal(t, err, nil)
	Equal(t, dt, "2 มกราคม  2006 15 นาฬิกา 04 นาที 05 วินาที")
